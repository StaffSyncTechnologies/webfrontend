...
import { useClientLoginMutation } from '../../store/slices/clientSlice';
...
export function ClientLogin() {
  ...
  const [clientLogin, { isLoading, isSuccess, isError, data, error }] = useClientLoginMutation();
  ...
  }, [isSuccess, isError, data, error, navigate, from, toast]);
  ...
  return (
    <AuthContainer>
      <Container>
        ...
        <Subtitle>Login to access your client dashboard</Subtitle>
        ...
        <LoginButton onClick={handleSubmit} disabled={!isValid || isLoading}>
          {isLoading ? <CircularProgress size={20} sx={{ color: 'white' }} /> : 'Login as Client'}
        </LoginButton>
      </Container>
    </AuthContainer>
  );
