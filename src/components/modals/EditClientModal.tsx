...
import { useUpdateClient, useClientDetails } from '../../hooks/api/useClientsApi';
...
// ============ COMPONENT ============
export function EditClientModal({ open, onClose, onSuccess, clientId }: EditClientModalProps) {
  const updateClient = useUpdateClient();
  const { data: clientData, isLoading: loadingClient } = useClientDetails(clientId || '');
  ...
  useEffect(() => {
    if (clientData) {
      setFormData({
        ...
        defaultPayRate: clientData.defaultPayRate ? String(clientData.defaultPayRate) : '',
        defaultChargeRate: clientData.defaultChargeRate ? String(clientData.defaultChargeRate) : '',
        ...
        <ModalCard>
          ...
          {loadingClient ? (
            ...
            <>
              ...
              <ModalTitle>Client Updated!</ModalTitle>
              <SuccessText>
            ...
            <>
              ...
              <ModalSubtitle>Update the client details below</ModalSubtitle>
              ...
              <FormGroup>
                ...
                <FormControl fullWidth>
                  <StyledSelect
                    ...
                    onChange={(e) => handleChange('status')({ target: { value: e.target.value as string } })}
                  >
              ...
              {updateClient.isError && (
                <ErrorText>Failed to update client. Please try again.</ErrorText>
              )}

              <SubmitButton onClick={handleSubmit} disabled={updateClient.isPending}>
