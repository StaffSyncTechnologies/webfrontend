...
export function AuthGuard({ children }: AuthGuardProps) {
  ...
  const publicRoutes = ['/login', '/client-login', '/register', '/forgot-password', '/reset-password', '/contact-us', '/watch-demo', '/get-started', '/privacy', '/terms', '/cookies', '/gdpr', '/delete-account', '/delete-data', '/'];
